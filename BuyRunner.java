class BuyRunner
{
	...
	{
		System.out.println("running main method with valid arguments");				
		product("hairbands",25.46);		
		product("rice",25,"premium",1740.56);
		bookMovieTicket("kalki","mallikarjunaTheatre",10,599.90);
		buyEggs(500,6000);
		buyShampoo(150,75.27,"meeraShampoo","jan2024");
		buyCake('B',"pinata","chocolate",400.50,1);
		buyLaptop("lenovo",744236665,65000,2000,5000,"windows",4554,6543);
		buySmartWatch("boat",1700,3,'d',3);
	}
}